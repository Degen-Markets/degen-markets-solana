...
describe('Wins claiming', () => {
    ...
    it('should not let a user claim if they did not win', async () => {
        ...
        const imageUrl = "https://example.com/image.png";
        const description = "This is a pool to guess if a SOL ETF will be approved by the end of 2024.";
    ...
    it("should claim the user's share of the win", async () => {
        ...
        const user2 = await generateKeypair();
        const imageUrl = "https://example.com/image.png";
        const description = "This is a pool to guess if Ethereum's market cap will surpass Bitcoin's.";
