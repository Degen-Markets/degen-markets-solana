...
export const getTitleHash = (title: string) => getBytesFromHashedStr(title) as unknown as number[];

export const getOptionTitleHash = (poolAccountKey: anchor.web3.PublicKey, title: string) =>
